...
struct AppleGuide {
    var outline = [
        ...
        L(
            t: "基础库", icon: "globe.asia.australia.fill",
            sub: [
                L(
                    t: "系统及设备",
                    sub: [
                ...
                L(
                    t: "时间", icon: "calendar.badge.clock",
                    sub: [
                        L(t: "时间"),
                        L(t: "日期组件"),
                        L(t: "TimeInterval"),
        ...
        L(
            t: "SwiftUI", icon: "heart.text.square.fill",
            sub: [
                L(
                    t: "介绍",
                    sub: [
                ...
                L(
                    t: "数据集合组件", icon: "list.bullet.rectangle.fill",
                    sub: [
                        L(t: "ForEach"),
                        L(
                            t: "Scroll视图", icon: "scroll.fill",
                            sub: [
                        ...
                        L(
                            t: "List列表", icon: "list.bullet.rectangle.portrait.fill",
                            sub: [
                        ...
                        L(
                            t: "Table表格", icon: "tablecells.fill",
                            sub: [
                ...
                L(
                    t: "布局组件", icon: "rectangle.3.group.fill",
                    sub: [
                        L(
                            t: "Navigation导航", icon: "sidebar.squares.leading",
                            sub: [
        ...
        L(
            t: "多线程", icon: "text.line.first.and.arrowtriangle.forward",
            sub: [
                L(
                    t: "Swift Concurrency",
                    sub: [
        ...
        L(
            t: "图片处理", icon: "photo.stack",
            sub: [
                L(t: "图片处理-基础")
            ]),
        L(
            t: "动画", icon: "moonphase.waning.gibbous.inverse",
            sub: [
        ...
        L(
            t: "网络", icon: "point.3.connected.trianglepath.dotted",
            sub: [
                L(t: "截获网络请求数据"),
                L(t: "网络状态检查"),
                L(t: "WKWebView"),
        ...
        L(
            t: "性能优化", icon: "battery.100percent.bolt",
            sub: [
                L(
                    t: "UI性能",
                    sub: [
        ...
        L(
            t: "调试", icon: "ant.circle.fill",
            sub: [
                L(t: "调试"),
                L(t: "LLDB"),
            ]),
        L(
            t: "测试", icon: "testtube.2",
            sub: [
                L(t: "自动化测试"),
                L(t: "XCTest"),
                L(t: "测试-代码覆盖率"),
        ...
        L(
            t: "安全", icon: "cross.case",
            sub: [
                L(t: "安全-介绍"),
                L(t: "Keychain"),
            ]),
        L(
            t: "工程实践", icon: "building.columns.fill",
            sub: [
                L(
                    t: "包管理工具",
                    sub: [
        ...
        L(
            ...
            sub: [
                ...
                L(
                    ...
                    sub: [
                        L(t: "MVVM+SwiftUI"),
                        L(t: "The Composable Architecture"),
                        L(t: "Redux风格架构"),
                        L(t: "Clean SwiftUI"),
                    ]),
            ]),
        L(
            t: "macOS", icon: "macstudio",
            sub: [
                L(t: "macOS范例"),
                L(t: "三栏结构"),
                L(t: "全屏模式"),
